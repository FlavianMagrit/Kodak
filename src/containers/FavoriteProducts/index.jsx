...
export const FavoriteProductCard = ({ name, price, color, note, checked }) => {
  if (color === undefined) {
    color = 'gris';
  }
  ...
  return (
    <div
      className={
        checked ? 'favorite-product-container' : 'favorite-product-container hide'
      }
    >
      <img
...
export const AllProducts = ({ name, price, color, note }) => {
  if (color === undefined) {
    color = 'gris';
  }
