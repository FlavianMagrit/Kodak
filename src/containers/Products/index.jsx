    ...
    <div className="pictures-container flex asc mb-2 relative">
      ...
      <div className="mobile-square flex">
        <div className="big-picture">
          ...
          <p className="tac m-1">Téléchargez notre application et accédez à votre cloud</p>
        </div>

        <div className="small-picture">
          <img src={Book} alt="Book2" />
          <b className="tac">Reconditionnés</b>
          <p className="tac m-1">Retrouvez toutes nos offres d'abonnement et profitez de vos photos</p>
        </div>
      </div>
